...
namespace MKL{
    ...
    void MxV(const MKL_INT& rows, const MKL_INT& cols, const MKL_Complex16& alpha, const std::vector<MKL_Complex16>& val, const std::vector<MKL_INT>& colIndx, const std::vector<MKL_INT>& rowIndx , const MKL_Complex16 *vecIn , const MKL_Complex16& beta , MKL_Complex16 *vecOut);
